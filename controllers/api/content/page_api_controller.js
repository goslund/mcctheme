...
module.exports = function(pb) {
    ...
    PageApiController.getRoutes = function(cb) {
        var routes = [{
            method: 'get',
            path: "/api/content/pages2",
            handler: "getAll",
            content_type: 'application/json',
            auth_required: true,
            inactive_site_access: true,
            access_level: pb.SecurityService.ACCESS_WRITER,
            controller: path.join(pb.config.docRoot, 'plugins/mcctheme/controllers/api/content/page_api_controller.js')
        }, ];
        cb(null, routes);
    };
